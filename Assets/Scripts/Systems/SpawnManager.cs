    ...
    public class SpawnManager : MonoBehaviour
    {
        ...
        [SerializeField] private float waitSpawnStrongTimer; //time to increase the ratio of stronger enemies
        [SerializeField] private float waitSpawnTimerDecrease; //decrease time between spawns
        
        [SerializeField] private float spawnTimerDecreaseRate; //rate that the spawn timer decreases
        
        List<Enemy> enemies = new List<Enemy>();
        
        [SerializeField] private int strongEnemySpawnChance = 0;
        [SerializeField] private float waitSpawnTimerBoss; //time to spawn boss
